...
- `queryFormatLanguage` (optional): Query language (e.g., `sparql`)
- `queryFormatVersion` (optional): Query language version (e.g., `1.0`, `1.1`, `1.2`)
...
- `baseIRI` (optional): Base IRI for resolving relative IRIs in the RDF dataset
- `queryFormatLanguage` (optional): Query language (e.g., `sparql`)
- `queryFormatVersion` (optional): Query language version (e.g., `1.0`, `1.1`, `1.2`)
